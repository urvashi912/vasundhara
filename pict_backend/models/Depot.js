...
Depot.prototype.reverseGeocode = async function (lat, lon) {
    const apiKey = "AIzaSyDlaOgAIfENMBp18EY8vn07MdtTd0QwmUU";
...
Depot.prototype.addDepot = async function () {
    let formattedAddress = await this.reverseGeocode(
        this.data.depotLocation.lat,
        this.data.depotLocation.lon
    );
